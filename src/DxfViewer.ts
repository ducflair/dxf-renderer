...
import type { DxfViewerLoadParams } from "./types.js"
...
export class DxfViewer {
    ...
    modelScene: any;
    modelOrigin: any;
    modelBlocks: Map<string, any>;
    viewports: any[];
    imageResources: any[];
    imageTexturePromises: Map<string, any>;
    missingImagePaths: Set<string>;
    viewportCamera: three.OrthographicCamera;
    ownsRenderer: boolean;
    renderer: any;
    camera: three.OrthographicCamera;
    simpleColorMaterial: any[];
    simplePointMaterial: any[];
    canvasWidth: number;
    canvasHeight: number;
    resizeObserver: any;
    controls: any;
     ...
     */
    async Load({url, fonts = null, images = null, progressCbk = null, workerFactory = null}: DxfViewerLoadParams): Promise<void> {
    ...
    _Message(message: string, level: string = MessageLevel.INFO) {
    ...
    _CreateImageBoundary(vertices, layer) {
        ...
        (object as any)._dxfViewerLayer = layer
    ...
    _CreateSimpleColorMaterial(instanceType: number = InstanceType.NONE) {
    ...
    _CreateSimplePointMaterial(instanceType: number = InstanceType.NONE) {
...
class Batch {
    ...
    *_CreateObjects(instanceBatch: any = null) {
        ...
        function CreateObject(vertices: any, indices?: any) {
