 ...
 * @param a1 First segment start point.
 * @param a2 First segment end point.
 * @param b1 Second segment start point.
 * @param b2 Second segment end point.
 * @param force Force intersection calculation even if intersection point is out of
 *  segment range.
 * @return Parameters for the first and second segment in the intersection point
 ...
 */
export function IntersectSegmentsParametric(
    a1: Vector2,
    a2: Vector2,
    b1: Vector2,
    b2: Vector2,
 ...
 * @param b1 Second segment start point.
 * @param b2 Second segment end point.
 * @return Intersection point coordinate, null if no intersection.
 */
